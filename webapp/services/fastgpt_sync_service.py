...
class FastGPTSyncService:
        ...
        payload: dict[str, Any] = {
            ...
            "metadata": {
                ...
                "source_file_name": str(
                    task.get("source_file_filename")
                    or task.get("stored_pdf_filename")
                    or task.get("original_filename")
                    or ""
                ),
                "source_file_ext": str(task.get("source_file_ext") or ""),
                "source_mime_type": str(task.get("source_mime_type") or ""),
                "processor_type": str(task.get("processor_type") or ""),
    ...
    def _build_collection_name(self, task: dict[str, Any], markdown_path: Path) -> str:
        ...
        return str(task.get("doc_id") or "document")
