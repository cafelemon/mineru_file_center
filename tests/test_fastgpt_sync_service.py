    ...
    def test_sync_markdown_success_replaces_previous_collection(self):
        ...
        result = service.sync_markdown(
            task={
                ...
                "source_file_filename": "doc-1.pdf",
                "source_file_ext": ".pdf",
        ...
        self.assertEqual(requests[-1][1]["name"], "doc-1.md")
        self.assertEqual(requests[-1][1]["text"], "# title\n\ncontent")
        self.assertEqual(requests[-1][1]["metadata"]["source_file_ext"], ".pdf")
        self.assertEqual(requests[-1][1]["metadata"]["processor_type"], "mineru_pdf")
